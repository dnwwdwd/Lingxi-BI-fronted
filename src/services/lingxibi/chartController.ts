...
export async function listMyChartByPageEsUsingPOST(
  ...
  return request<API.BaseResponsePageChart_>('/api/chart/search/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** updateChart POST /api/chart/regen */
export async function regenChartUsingPOST(
  body: API.ChartUpdateRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseBoolean_>('/api/chart/regen', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
